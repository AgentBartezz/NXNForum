...
class ForumCategory
{
     ...
     * Add sections
     *
     * @param \NXN\NXNForumBundle\Entity\ForumSection $sections
     * @return ForumCategory
     */
    public function addSection(\NXN\NXNForumBundle\Entity\ForumSection $sections)
    {
     ...
     * @param \NXN\NXNForumBundle\Entity\ForumSection $sections
     */
    public function removeSection(\NXN\NXNForumBundle\Entity\ForumSection $sections)
    {
